Public Class ucrValueFlagPeriodNew
    ...
    'TODO relook at this functions from the ucrBaseDatalink
    ...
    Public Sub SetValueFlagPeriodFields(strValueFieldName As String, strFlagFieldName As String, strPeriodFieldName As String)
        'TODO relook setting fields in the ucrdataStructure
    ...
    Public Sub SetTableNameAndValueFlagPeriodFields(strNewTable As String, strValueFieldName As String, strFlagFieldName As String, strPeriodFieldName As String)
        'TODO relook setting TableName in the ucrdataStructure
    ...
    Public Sub SetFlagField(strFlagFieldName As String)
        'TODO relook at the ucrBasedatalink
        'ucrFlag.SetField(strFlagFieldName)
    End Sub

    Public Sub SetPeriodField(strPeriodFieldName As String)
        'TODO relook at the setField function  in ucrBaseDatalink
    ...
    Public Overrides Sub UpdateValueChoices()
        If Not bFirstLoad Then
            ...
            ucrValue.UpdateValueChoices()
            ucrFlag.UpdateValueChoices()
            If bIncludePeriod Then
                ucrPeriod.UpdateValueChoices()
            End If
        End If
    End Sub
    ...
    Private Sub ucrValueFlagPeriod_KeyDown(sender As Object, e As KeyEventArgs) Handles ucrValue.evtKeyDown
