Public Class ucrHourlyNew
    ...
    Private Sub UcrHourly_Load(sender As Object, e As EventArgs) Handles Me.Load
        If bFirstLoad Then
            ...
            'TODO Relook at this functionality
    ...
    Private Sub btnAddNew_Click(sender As Object, e As EventArgs) Handles btnAddNew.Click
        Try
            'TODO Look at the navigator
            'ucrNavigator.NewSequencerRecord(txtSequencer.Text, {"elementId", "mm", "dd"}, {ucrDaySelector, ucrMonthSelector}, ucrYearSelector)
            ' ucrNavigation.NewRecord() 'temporary
            SaveEnable()
            ucrValueFlagPeriod00.Focus()
    ...
    Private Sub BtnUpload_Click(sender As Object, e As EventArgs) Handles btnUpload.Click
        ...
        'TODO Relook at this methods ie setHeader and setProgressMaximum
    ...
    Private Sub btnHelp_Click(sender As Object, e As EventArgs) Handles ucrBtnHelp.Click
    ...
    Private Sub btnAssignSameValue_Click(sender As Object, e As EventArgs) Handles btnAssignSameValue.Click
        Dim strNewValue As String = UcrTextBoxNew1.GetValue
        Dim ucrVFP As ucrValueFlagPeriod
    ...
    Private Sub ucrInputTotal_evtKeyDown(sender As Object, e As KeyEventArgs) Handles ucrTxtInputTotal.evtKeyDown
        If e.KeyCode = Keys.Enter Then
            If Not CheckTotal() Then
                ucrTxtInputTotal.Focus()
    ...
    Private Function CheckTotal() As Boolean
        ...
        If bTotalRequired Then
            If ucrTxtInputTotal.IsEmpty Then
                ...
                ucrTxtInputTotal.SetBackColor(Color.Red)
                bValueCorrect = False
            Else
                expectedTotal = Val(ucrTxtInputTotal.GetValue)
                For Each ctr As Control In Me.Controls
                    If TypeOf ctr Is ucrValueFlagPeriod Then
