...
Partial Class formProductsSelectCriteria
    ...
    Private Sub InitializeComponent()
        ...
        '
        resources.ApplyResources(Me.cmdSelectAllElements, "cmdSelectAllElements")
        ...
        resources.ApplyResources(Me.pnlExtremes, "pnlExtremes")
        Me.pnlExtremes.Name = "pnlExtremes"
        '
        'btnMinDate
        '
        resources.ApplyResources(Me.btnMinDate, "btnMinDate")
        Me.btnMinDate.Name = "btnMinDate"
        Me.btnMinDate.UseVisualStyleBackColor = True
        '
        'btnMaxDate
        '
        resources.ApplyResources(Me.btnMaxDate, "btnMaxDate")
        Me.btnMaxDate.Name = "btnMaxDate"
        Me.btnMaxDate.UseVisualStyleBackColor = True
        '
        'btnLowHigh
        '
        resources.ApplyResources(Me.btnLowHigh, "btnLowHigh")
        ...
        'lblXtyp
        '
        resources.ApplyResources(Me.lblXtyp, "lblXtyp")
