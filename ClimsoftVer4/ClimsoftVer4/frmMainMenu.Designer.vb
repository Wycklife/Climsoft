...
Partial Class frmMainMenu
    ...
    Private Sub InitializeComponent()
        ...
        resources.ApplyResources(Me.UserRecordsToolStripMenuItem1, "UserRecordsToolStripMenuItem1")
        '
        'mnuProducts
        '
        ...
        resources.ApplyResources(Me.ConfigureDatabaseConnectionToolStripMenuItem, "ConfigureDatabaseConnectionToolStripMenuItem")
        '
        'UpdateObservationsToolStripMenuItem1
        '
        Me.UpdateObservationsToolStripMenuItem1.Name = "UpdateObservationsToolStripMenuItem1"
        resources.ApplyResources(Me.UpdateObservationsToolStripMenuItem1, "UpdateObservationsToolStripMenuItem1")
        '
        'OpeartionsMonitoringToolStripMenuItem
        '
        Me.OpeartionsMonitoringToolStripMenuItem.Name = "OpeartionsMonitoringToolStripMenuItem"
        resources.ApplyResources(Me.OpeartionsMonitoringToolStripMenuItem, "OpeartionsMonitoringToolStripMenuItem")
        '
        'EmptyKeyEntryTablesToolStripMenuItem
        '
        Me.EmptyKeyEntryTablesToolStripMenuItem.Name = "EmptyKeyEntryTablesToolStripMenuItem"
        resources.ApplyResources(Me.EmptyKeyEntryTablesToolStripMenuItem, "EmptyKeyEntryTablesToolStripMenuItem")
        '
        'ChangeOwnPasswordToolStripMenuItem
        '
        Me.ChangeOwnPasswordToolStripMenuItem.Name = "ChangeOwnPasswordToolStripMenuItem"
        resources.ApplyResources(Me.ChangeOwnPasswordToolStripMenuItem, "ChangeOwnPasswordToolStripMenuItem")
        '
        'mnuTools
        '
        ...
        resources.ApplyResources(Me.AWSElementsToolStripMenuItem, "AWSElementsToolStripMenuItem")
        '
        'AWSStationsToolStripMenuItem
        '
        Me.AWSStationsToolStripMenuItem.Name = "AWSStationsToolStripMenuItem"
        resources.ApplyResources(Me.AWSStationsToolStripMenuItem, "AWSStationsToolStripMenuItem")
        '
        'ConfigurationForTDCFToolStripMenuItem
        '
        Me.ConfigurationForTDCFToolStripMenuItem.Name = "ConfigurationForTDCFToolStripMenuItem"
        resources.ApplyResources(Me.ConfigurationForTDCFToolStripMenuItem, "ConfigurationForTDCFToolStripMenuItem")
        '
